...
export const ADMIN_SHORTCUT_GROUPS: AdminShortcutGroup[] = [
  ...
  /* ─────────────────── 07 · RÔLES ─────────────────── */
  {
    ...
    description:
      "Configurer les niveaux, permissions et protections des rôles sensibles.",
    modules: [
      {
        title: "Table des rôles",
        description: "Créer, ajuster ou bloquer les rôles d'administration.",
        href: "/admin/role",
        cta: "Afficher",
        icon: Shield,
        tone: "text-cyan-200",
      },
       {
        ...
        description: "Console modulaire pour créer, modifier et attribuer les permissions.",
        href: "/admin/roles",
        cta: "Afficher",
        icon: UserCog,
        tone: "text-violet-500",
      ...
      {
        title: "Matrice RBAC",
        description: "Comparer les permissions par rôle, niveau et zone applicative.",
