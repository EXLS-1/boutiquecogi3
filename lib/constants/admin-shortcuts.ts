...
export const ADMIN_SHORTCUT_GROUPS: AdminShortcutGroup[] = [
  ...
  /* ─────────────────── 02 · PRODUITS ─────────────────── */
  {
    ...
    description:
      "Administrer le catalogue complet : création, fiches, prix, stocks, catalogues, catégories, workflow de publication et analytiques.",
    modules: [
      {
        title: "Dashboard Produits",
        description: "Vue opérationnelle avec KPIs, filtres et liste paginée du catalogue.",
        href: "/admin/products",
        cta: "Consulter",
        icon: PackageSearch,
        tone: "text-cyan-200",
      },
      {
        ...
        description: "Wizard de création 7 étapes : produit, variantes, prix, stock, médias, SEO.",
      ...
      },
      {
        ...
        description: "Workflow DRAFT → PENDING → PUBLISHED : soumettre, approuver, programmer, archiver.",
      ...
      },
      {
        ...
        description: "Gérer les attributs produits (taille, couleur, matière) et configurations variantes.",
      ...
      {
        title: "Catalogues",
        description: "Gérer les catalogues, prix par catalogue et assignation de visibilité.",
        href: "/admin/products/catalogs",
        cta: "Gérer",
        icon: ShoppingBag,
        tone: "text-indigo-500",
      },
      {
        title: "Catégories",
        description: "Gérer l'arbre des catégories produit (hiérarchie, drag & drop).",
      ...
      {
        title: "Tags",
        description: "Gérer les tags produits avec compteur d'utilisation.",
      ...
      },
      {
        ...
        description: "Gérer les stocks, mouvements (IN/OUT/ADJUSTMENT), réserves et alertes.",
      ...
      {
        title: "Import CSV",
        description: "Importer des produits en masse via fichier CSV avec validation.",
      ...
      },
      {
        ...
        description: "Gérer les prix multidevises, comparatifs, soldes et promotions.",
      ...
      },
      {
        ...
        description: "Statistiques : vues, ventes, notes, valeur stock et tendances.",
      ...
      {
        title: "Médias Produits",
        description: "Gérer les images, vidéos et galeries des fiches produits.",
      ...
      },
      {
        ...
        description: "Consulter l'historique des modifications et la traçabilité des actions.",
        href: "/admin/products/history",
        cta: "Consulter",
        icon: History,
        tone: "text-slate-500",
      },
      {
        ...
        description: "Création dynamique rapide : nom + prix → variante + stock auto-créés.",
        href: "/admin/products/dynamic",
        cta: "Créer",
        icon: Sparkles,
      ...
      },
      {
        ...
        description: "Exporter le catalogue produits (CSV, JSON) avec filtres appliqués.",
  ...
  /* ─────────────────── 06 · UTILISATEURS ─────────────────── */
  {
    ...
    modules: [
      ...
      {
        title: "Rbac utilisateur",
        description: "Comparer et configurer la matrice des permissions par rôle et niveau.",
        href: "/admin/users/rbac",
        cta: "Afficher",
        icon: ShieldCheck,
        tone: "text-cyan-500",
      },
      {
        ...
        description: "Ajuster les rattachements RBAC et niveaux d'accès pour chaque utilisateur.",
      ...
      },
      {
        ...
        description: "Identifier les comptes bloqués/debloqués et rétablir un accès valide.",
