...
export const PERMISSIONS = {
  ...
  "users:search:filter": "users:search:filter",
  ...
  // Legacy aliases retained for older seed/admin code references.
  USERS_READ: "users:read",
  USERS_CREATE: "users:create",
  USERS_UPDATE: "users:update",
  USERS_DELETE: "users:delete",
  USERS_BLOCK: "users:block",
  USERS_BAN: "users:block",
  USERS_UNBAN: "users:unban",
  USERS_IMPERSONATE: "users:impersonate",
  USERS_VIEW_ANY: "users:view:any",
  USERS_SEARCH: "users:search",
  USERS_FILTER_ACTIVE: "users:filter:active",
  USERS_FILTER_BLOCKED: "users:filter:blocked",
  USERS_FILTER_INACTIVE: "users:filter:inactive",
  ROLE_VIEW: "role:view",
...
export const PERMISSION_META: Record<PermissionCode, { category: string; minLevel: number; isDangerous: boolean; description: string }> = {
  ...
  [PERMISSIONS["users:export"]]: { category: "USER", minLevel: 4, isDangerous: false, description: "Exporter les utilisateurs" },
  [PERMISSIONS["users:filter:view"]]: { category: "USER", minLevel: 1, isDangerous: false, description: "Voir les filtres utilisateurs" },
  [PERMISSIONS["users:search:filter"]]: { category: "USER", minLevel: 1, isDangerous: false, description: "Rechercher et filtrer les utilisateurs" },
  [PERMISSIONS["users:blocked"]]: { category: "USER", minLevel: 2, isDangerous: false, description: "Voir les utilisateurs bloqués" },
  [PERMISSIONS["users.filter:inactive"]]: { category: "USER", minLevel: 2, isDangerous: false, description: "Filtrer les utilisateurs inactifs" },
  ...
  [PERMISSIONS["categories:reorder"]]: { category: "CATEGORY", minLevel: 3, isDangerous: false, description: "Réordonner les catégories" },
