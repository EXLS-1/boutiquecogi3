...
const AUDIT_EVENT_TYPES: AuditEventType[] = [
  {
    ...
    requiredPermissionView: PERMISSIONS["system:logs"],
    requiredPermissionDelete: PERMISSIONS["system:maintenance"],
    minRoleLevelView: LEVELS.LEVEL_5, minRoleLevelDelete: LEVELS.LEVEL_1, retentionDays: 90, isImmutable: true,
  },
  {
    ...
    requiredPermissionView: PERMISSIONS["system:logs"],
    requiredPermissionDelete: PERMISSIONS["system:maintenance"],
    minRoleLevelView: LEVELS.LEVEL_2, minRoleLevelDelete: LEVELS.LEVEL_1, retentionDays: 365, isImmutable: true,
  },
  {
    ...
    requiredPermissionView: PERMISSIONS["products:read"],
    requiredPermissionDelete: PERMISSIONS["system:maintenance"],
    minRoleLevelView: LEVELS.LEVEL_4, minRoleLevelDelete: LEVELS.LEVEL_2, retentionDays: 180, isImmutable: true,
  },
  {
    ...
    requiredPermissionView: PERMISSIONS["products:read"],
    requiredPermissionDelete: PERMISSIONS["system:maintenance"],
    minRoleLevelView: LEVELS.LEVEL_3, minRoleLevelDelete: LEVELS.LEVEL_1, retentionDays: 365, isImmutable: true,
  },
  {
    ...
    requiredPermissionDelete: PERMISSIONS["system:maintenance"],
    minRoleLevelView: LEVELS.LEVEL_5, minRoleLevelDelete: LEVELS.LEVEL_2, retentionDays: 180, isImmutable: true,
  },
  {
    ...
    requiredPermissionView: PERMISSIONS["orders:read"],
    requiredPermissionDelete: PERMISSIONS["system:maintenance"],
    minRoleLevelView: LEVELS.LEVEL_3, minRoleLevelDelete: LEVELS.LEVEL_1, retentionDays: 730, isImmutable: true,
  },
  {
    ...
    whoCanDelete: [ROLES.SUPER_ADMIN],
    requiredPermissionView: PERMISSIONS["settings:roles-manage"],
    requiredPermissionDelete: PERMISSIONS["system:maintenance"],
    minRoleLevelView: LEVELS.LEVEL_1, minRoleLevelDelete: LEVELS.LEVEL_1, retentionDays: 730, isImmutable: true,
  },
  {
  ...
  },
  {
    ...
    requiredPermissionView: PERMISSIONS["system:logs"],
    requiredPermissionDelete: PERMISSIONS["system:maintenance"],
    minRoleLevelView: LEVELS.LEVEL_2, minRoleLevelDelete: LEVELS.LEVEL_1, retentionDays: 730, isImmutable: true,
  },
  {
    ...
    requiredPermissionView: PERMISSIONS["system:logs"],
    requiredPermissionDelete: PERMISSIONS["system:maintenance"],
    minRoleLevelView: LEVELS.LEVEL_2, minRoleLevelDelete: LEVELS.LEVEL_1, retentionDays: 30, isImmutable: true,
  },
  {
    ...
    whoCanDelete: [ROLES.SUPER_ADMIN],
    requiredPermissionView: PERMISSIONS["audit:view-logs"],
    requiredPermissionDelete: PERMISSIONS["system:maintenance"],
    minRoleLevelView: LEVELS.LEVEL_2, minRoleLevelDelete: LEVELS.LEVEL_1, retentionDays: 365, isImmutable: true,
  },
  {
    ...
    severity: "CRITICAL", whoCanView: [ROLES.SUPER_ADMIN],
    whoCanDelete: [ROLES.SUPER_ADMIN],
    requiredPermissionView: PERMISSIONS["audit:approve-request"],
    requiredPermissionDelete: PERMISSIONS["system:maintenance"],
    minRoleLevelView: LEVELS.LEVEL_1, minRoleLevelDelete: LEVELS.LEVEL_1, retentionDays: 730, isImmutable: true,
  },
  {
...
const RETENTION_POLICIES: RetentionPolicy[] = [
  ...
  },
  {
    ...
    whoCanConfigure: [ROLES.SUPER_ADMIN], minRoleLevel: LEVELS.LEVEL_1,
...
export async function seedAuditEventTypes(prisma: PrismaClient) {
  console.log("📋 [RBAC] Configuration atomique des types d'événements d'audit...");

  await prisma.$transaction(
    AUDIT_EVENT_TYPES.map((event) =>
      prisma.auditEventType.upsert({
...
export async function seedRetentionPolicies(prisma: PrismaClient) {
  console.log("🗄️  [RBAC] Configuration atomique des politiques de rétention...");
