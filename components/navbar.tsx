...
export const Navbar = () => {
  ...
  return (
   <nav className="fixed top-0 left-0 right-0 z-50 h-16 bg-slate-50 border-b border-cyan-400">
      <div className="max-w-10xl mx-auto h-full px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link 
            href="/" 
            className="font-playfair text-2xl md:text-2xl font-bold tracking-widest text-cyan-400 hover:text-pink-400 transition-colors"
          >
            Boutique COGI
          </Link>
        </div>
