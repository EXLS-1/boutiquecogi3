...
// Ce composant de barre de navigation est conçu pour être flexible et réutilisable,
// avec des sous-composants pour la marque, la recherche, les rôles et le panier.
...
import { CurrencySwitcher } from "@/components/price/currency-switcher";
